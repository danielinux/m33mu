...
#ifndef M33MU_IMXRT700_TIMERS_H
#define M33MU_IMXRT700_TIMERS_H

#include "m33mu/types.h"

/* CTIMER0..7 and the OS event timer (one shared counter, a match/interrupt
 * block per CPU). */
